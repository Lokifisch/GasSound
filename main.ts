...
while (true) {
    music.play(music.createSoundExpression(WaveShape.Sawtooth, 917, 917, 255, 255, 9999, SoundExpressionEffect.Tremolo, InterpolationCurve.Linear), music.PlaybackMode.UntilDone)
}
